...
{
    /// <summary>
    /// Custom vertex type for CipherNocturne's beam trail primitive rendering.
    /// Position + Color + UV.xy + WidthCorrection.z
    /// </summary>
    public readonly struct CipherVertex : IVertexType
    {
        ...
        public CipherVertex(Vector2 position, Color color, Vector2 uv, float widthCorrection)
        {
            Position = position;
            Color = color;
