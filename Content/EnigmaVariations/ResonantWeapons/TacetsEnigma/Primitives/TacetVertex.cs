...
{
    /// <summary>
    /// Custom vertex type for TacetsEnigma's bullet/paradox bolt trail primitive rendering.
    /// Position + Color + UV.xy + WidthCorrection.z
    /// </summary>
    public readonly struct TacetVertex : IVertexType
    {
        ...
        public TacetVertex(Vector2 position, Color color, Vector2 uv, float widthCorrection)
        {
            Position = position;
            Color = color;
