...
{
    /// <summary>
    /// Custom vertex type for TheSilentMeasure's seeker trail primitive rendering.
    /// Position + Color + UV.xy + WidthCorrection.z
    /// </summary>
    public readonly struct SilentVertex : IVertexType
    {
        ...
        public SilentVertex(Vector2 position, Color color, Vector2 uv, float widthCorrection)
        {
            Position = position;
            Color = color;
