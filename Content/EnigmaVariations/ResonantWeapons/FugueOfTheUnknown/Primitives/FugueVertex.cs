...
{
    /// <summary>
    /// Custom vertex type for FugueOfTheUnknown primitive rendering.
    /// Position + Color + UV.xy + WidthCorrection.z
    /// </summary>
    public readonly struct FugueVertex : IVertexType
    {
        ...
        public FugueVertex(Vector2 position, Color color, Vector2 uv, float widthCorrection)
        {
            Position = position;
            Color = color;
