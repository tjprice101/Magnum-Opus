...
{
    /// <summary>
    /// Custom vertex type for TheWatchingRefrain's phantom trail primitive rendering.
    /// Position + Color + UV.xy + WidthCorrection.z
    /// </summary>
    public readonly struct WatchingVertex : IVertexType
    {
        ...
        public WatchingVertex(Vector2 position, Color color, Vector2 uv, float widthCorrection)
        {
            Position = position;
            Color = color;
