...
{
    /// <summary>
    /// Custom vertex type for TheUnresolvedCadence primitive rendering.
    /// Position + Color + UV.xy + WidthCorrection.z
    /// </summary>
    public readonly struct CadenceVertex : IVertexType
    {
        ...
        public CadenceVertex(Vector2 position, Color color, Vector2 uv, float widthCorrection)
        {
            Position = position;
            Color = color;
