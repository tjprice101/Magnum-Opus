...
{
    /// <summary>
    /// ModSystem that manages TheUnresolvedCadence-exclusive particles.
    /// Hooks into Main.DrawDust for dual-pass rendering (additive + alpha).
    /// </summary>
    [Autoload(Side = ModSide.Client)]
    public sealed class CadenceParticleHandler : ModSystem
    {
        private static readonly List<CadenceParticle> _particles = new(500);
        private const int MaxParticles = 500;

        public override void OnModLoad()
        {
            On_Main.DrawDust += DrawCadenceParticles;
        }
        ...
        public static void Spawn(CadenceParticle particle)
        {
        ...
        private void DrawCadenceParticles(On_Main.orig_DrawDust orig, Main self)
        {
            orig(self);
