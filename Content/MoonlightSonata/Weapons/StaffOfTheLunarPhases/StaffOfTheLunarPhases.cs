...
{
    /// <summary>
    /// Staff of the Lunar Phases  E"The Conductor's Baton".
    /// Summons a Goliath of Moonlight that fires ricocheting moonlight beams.
    /// Right-click toggles Conductor Mode  Edirect the Goliath's beams toward your cursor.
    ...
    public class StaffOfTheLunarPhases : ModItem
    {
            ...
            Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            if (!Main.dedServ)
            {
                ...
                // Lunar phase rings  Eexpanding ritual circles
                ...
                // Radial music note burst  Emore notes, phase-tinted
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new TooltipLine(Mod, "Effect3",
                "Each beam hit restores health  EWaning phase restores the most"));
            tooltips.Add(new TooltipLine(Mod, "Effect4",
                "Right-click to toggle Conductor Mode  Edirect the Goliath's beams toward your cursor"));
            tooltips.Add(new TooltipLine(Mod, "Effect5",
                "The Goliath cycles through lunar phases  Eeach phase alters beam power and behavior"));
            ...
            tooltips.Add(new TooltipLine(Mod, "Lore",
                "'The conductor raises the baton  Eand the moonlight obeys'")
