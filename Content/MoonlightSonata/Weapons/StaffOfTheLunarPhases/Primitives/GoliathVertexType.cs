...
{
    /// <summary>
    /// Custom vertex type for Goliath moonlight beam trail rendering.
    /// Position2D + Color + TexCoord3 (U, V, widthCorrection).
    /// </summary>
    public struct GoliathVertexType : IVertexType
    {
        ...
        public GoliathVertexType(Vector2 position, Color color, Vector2 uv, float widthCorrection = 0f)
        {
            Position = position;
            Color = color;
