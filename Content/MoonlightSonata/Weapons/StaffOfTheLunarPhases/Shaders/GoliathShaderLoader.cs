...
namespace MagnumOpus.Content.MoonlightSonata.Weapons.StaffOfTheLunarPhases.Shaders
{
    ...
    public sealed class GoliathShaderLoader : ModSystem
    {
        ...
        public override void PostSetupContent()
        {
            ...
            GameShaders.Misc["MagnumOpus:GoliathBeamMain"] = new MiscShaderData(GravitationalRiftAsset, "P0");
            GameShaders.Misc["MagnumOpus:GoliathBeamGlow"] = new MiscShaderData(GravitationalRiftAsset, "P0");
            ...
            GameShaders.Misc["MagnumOpus:GoliathDevastatingMain"] = new MiscShaderData(SummonCircleAsset, "P0");
            GameShaders.Misc["MagnumOpus:GoliathDevastatingGlow"] = new MiscShaderData(SummonCircleAsset, "P0");
            ...
            GameShaders.Misc["MagnumOpus:GoliathLunarBeam"] = new MiscShaderData(LunarBeamAsset, "P0");
            GameShaders.Misc["MagnumOpus:GoliathStandardPrimitive"] = new MiscShaderData(LunarBeamAsset, "P0");
        }
    }
}
