...
{
    /// <summary>
    /// Abstract base class for Moonlight's Calling's self-contained particle system.
    /// Mirrors the Eternal Moon pattern but scoped to the Serenade weapon.
    /// </summary>
    public abstract class SerenadeParticle
    {
        public int Time;
        public int Lifetime;
