...
{
    /// <summary>
    /// Configuration for the Serenade beam trail renderer.
    /// </summary>
    public struct SerenadeTrailSettings
    {
        /// <summary>Width of the trail at a given completion ratio (0 = start, 1 = end).</summary>
