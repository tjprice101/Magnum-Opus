...
namespace MagnumOpus.Content.MoonlightSonata.Weapons.MoonlightsCalling.Shaders
{
    ...
    public sealed class SerenadeShaderLoader : ModSystem
    {
        ...
        public override void PostSetupContent()
        {
            ...
            GameShaders.Misc["MagnumOpus:SerenadePrismaticBeam"] = new MiscShaderData(PrismaticBeamAsset, "PrismaticBeamMain");
            GameShaders.Misc["MagnumOpus:SerenadePrismaticGlow"] = new MiscShaderData(PrismaticBeamAsset, "PrismaticBeamGlow");
            ...
            GameShaders.Misc["MagnumOpus:SerenadeRefractionRipple"] = new MiscShaderData(RefractionRippleAsset, "RefractionRippleMain");
            GameShaders.Misc["MagnumOpus:SerenadeRefractionSubtle"] = new MiscShaderData(RefractionRippleAsset, "RefractionRippleSubtle");
            ...
            GameShaders.Misc["MagnumOpus:SerenadeLunarBeam"] = new MiscShaderData(LunarBeamAsset, "LunarBeamMain");

            // Fallback standard primitive reusing prismatic beam main pass
            GameShaders.Misc["MagnumOpus:SerenadeStandardPrimitive"] = new MiscShaderData(PrismaticBeamAsset, "PrismaticBeamMain");
        }
    }
}
