...
{
    /// <summary>
    /// Swan Lake Resonance Ore Tile - Uses a 3x3 sprite sheet (48x48 total) where each 16x16 frame is a unique ore variant.
    ...
    public class SwanLakeResonanceOreTile : ModTile
    {
        ...
        public override string Texture => "MagnumOpus/Content/SwanLake/ResonantOres/SwanLakeResonanceOreTile";
