...
namespace MagnumOpus.Content.ClairDeLune.Weapons.GearDrivenArbiter.Utilities
{
    /// <summary>
    /// Self-contained utility library for the Gear-Driven Arbiter weapon system.
    /// Clockwork brass with moonbeam gold palette  Eclockwork judge marking targets.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class GearDrivenArbiterUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Gear-Driven Arbiter summon gradient  Eclockwork judge with brass, blue, and gold.
        /// NightMist -> ClockworkBrass -> SoftBlue -> MoonbeamGold -> PearlWhite -> WhiteHot.
        /// </summary>
