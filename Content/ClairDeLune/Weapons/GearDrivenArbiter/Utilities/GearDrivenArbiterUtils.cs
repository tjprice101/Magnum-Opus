...
namespace MagnumOpus.Content.ClairDeLune.Weapons.GearDrivenArbiter.Utilities
{
    ...
    /// Clockwork brass with moonbeam gold palette — clockwork judge marking targets.
    ...
    public static class GearDrivenArbiterUtils
    {
        ...
        /// <summary>
        /// Gear-Driven Arbiter summon gradient — clockwork judge with brass, blue, and gold.
