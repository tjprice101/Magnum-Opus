...
{
    /// <summary>
    /// Self-contained utility library for the Clockwork Grimoire weapon system.
    /// Arcane palette  Emystical pages of temporal knowledge, channeled and building.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class ClockworkGrimoireUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Clockwork Grimoire cast gradient  Earcane pages with moonbeam gold accent.
        /// NightMist -> MidnightBlue -> SoftBlue -> MoonbeamGold -> PearlWhite -> WhiteHot.
        /// </summary>
