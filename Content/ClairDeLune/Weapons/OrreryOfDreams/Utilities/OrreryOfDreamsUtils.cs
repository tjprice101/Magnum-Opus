...
namespace MagnumOpus.Content.ClairDeLune.Weapons.OrreryOfDreams.Utilities
{
    /// <summary>
    /// Self-contained utility library for the Orrery of Dreams weapon system.
    /// Dreamy palette  Ecelestial spheres in dreamy orbit, cosmic dreamlike shimmer.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class OrreryOfDreamsUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Orrery of Dreams orbit gradient  Edreamy with pearl shimmer accent.
        /// NightMist -> MidnightBlue -> SoftBlue -> PearlBlue -> PearlShimmer -> WhiteHot.
        /// </summary>
