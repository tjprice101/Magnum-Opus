...
{
    /// <summary>
    /// Self-contained utility library for the Clockwork Harmony weapon system.
    /// Gear theme palette  Ebrass mechanism meets moonlit steel, heavy rhythmic pendulum.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class ClockworkHarmonyUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Clockwork Harmony blade gradient  Ebrass mechanism meets moonlit steel.
