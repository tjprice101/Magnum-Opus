...
namespace MagnumOpus.Content.ClairDeLune.Weapons.MidnightMechanism.Utilities
{
    ...
    /// Brass accent palette — gatling gun spinning in the dark with clockwork precision.
    ...
    public static class MidnightMechanismUtils
    {
        ...
        /// <summary>
        /// Midnight Mechanism burst gradient — clockwork gatling with starlight silver and brass.
