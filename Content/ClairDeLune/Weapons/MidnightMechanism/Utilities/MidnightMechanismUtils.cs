...
{
    /// <summary>
    /// Self-contained utility library for the Midnight Mechanism weapon system.
    /// Brass accent palette  Egatling gun spinning in the dark with clockwork precision.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class MidnightMechanismUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Midnight Mechanism burst gradient  Eclockwork gatling with starlight silver and brass.
        /// NightMist -> MidnightBlue -> StarlightSilver -> ClockworkBrass -> PearlWhite -> WhiteHot.
        /// </summary>
