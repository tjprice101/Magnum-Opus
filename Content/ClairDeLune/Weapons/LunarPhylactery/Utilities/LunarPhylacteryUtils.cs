...
namespace MagnumOpus.Content.ClairDeLune.Weapons.LunarPhylactery.Utilities
{
    /// <summary>
    /// Self-contained utility library for the Lunar Phylactery weapon system.
    /// Lunar gold palette  Edreamy soul vessel channeling moonlight with gold accent.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class LunarPhylacteryUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Lunar Phylactery summon gradient  Edreamy soul vessel with starlight silver.
        /// NightMist -> MidnightBlue -> SoftBlue -> PearlBlue -> StarlightSilver -> WhiteHot.
        /// </summary>
        public static readonly Color[] WeaponPalette = new Color[]
        {
            ...
            ClairDeLunePalette.StarlightSilver,
