...
namespace MagnumOpus.Content.ClairDeLune.Weapons.StarfallWhisper.Utilities
{
    /// <summary>
    /// Self-contained utility library for the Starfall Whisper weapon system.
    /// Starlight silver palette  Esniper rifle tracing starlit paths.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class StarfallWhisperUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Starfall Whisper shot gradient  Estarlit sniper with pearl blue and starlight silver.
