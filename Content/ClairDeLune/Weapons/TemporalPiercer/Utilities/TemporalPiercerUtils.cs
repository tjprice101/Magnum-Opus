...
{
    /// <summary>
    /// Self-contained utility library for the Temporal Piercer weapon system.
    /// Cool piercing palette  Ecrystalline lance of frozen time.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class TemporalPiercerUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Temporal Piercer lance gradient  Ecrystalline lance of frozen time.
