...
namespace MagnumOpus.Content.ClairDeLune.Weapons.RequiemOfTime.Utilities
{
    ...
    /// Temporal red accent palette — time-freeze magic sword with crimson undertone.
    ...
    public static class RequiemOfTimeUtils
    {
        ...
        /// <summary>
        /// Requiem of Time sweep gradient — time-freeze magic sword with starlight silver.
