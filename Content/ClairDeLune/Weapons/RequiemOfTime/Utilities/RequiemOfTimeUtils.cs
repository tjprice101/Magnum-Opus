...
namespace MagnumOpus.Content.ClairDeLune.Weapons.RequiemOfTime.Utilities
{
    /// <summary>
    /// Self-contained utility library for the Requiem of Time weapon system.
    /// Temporal red accent palette  Etime-freeze magic sword with crimson undertone.
    /// Contains easing functions, piecewise animation, color helpers, and SpriteBatch extensions.
    /// </summary>
    public static class RequiemOfTimeUtils
    {
        // ══════╁EWEAPON PALETTE ══════╁E

        /// <summary>
        /// Requiem of Time sweep gradient  Etime-freeze magic sword with starlight silver.
        /// NightMist -> MidnightBlue -> SoftBlue -> StarlightSilver -> PearlWhite -> WhiteHot.
        /// </summary>
