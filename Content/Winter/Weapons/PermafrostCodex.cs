    ...
    public class PermafrostCodex : ModItem
    {
        ...
        public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
        {
            try
            {
                ...
                spriteBatch.Draw(bloomTex, position, null, GlacialPurple * 0.3f, 0f, bloomOrigin, scale * pulse * 0.15f, SpriteEffects.None, 0f);
                spriteBatch.Draw(bloomTex, position, null, IceBlue * 0.2f, 0f, bloomOrigin, scale * 0.11f, SpriteEffects.None, 0f);
                spriteBatch.Draw(bloomTex, position, null, FrostWhite * 0.16f, 0f, bloomOrigin, scale * 0.08f, SpriteEffects.None, 0f);
