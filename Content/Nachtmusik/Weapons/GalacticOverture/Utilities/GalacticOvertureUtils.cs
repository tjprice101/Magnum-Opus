...
{
    /// <summary>
    /// Self-contained utility library for Galactic Overture.
    /// Includes easing functions, curve segments, palette helpers, and SpriteBatch extensions.
    /// </summary>
    public static class GalacticOvertureUtils
    {
        #region Color Palette — Galactic Overture

        /// <summary>Core 6-color palette: galactic void → overture white.</summary>
        public static readonly Color[] WeaponPalette = NachtmusikPalette.GalacticOvertureMinion;
