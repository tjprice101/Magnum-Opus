...
{
    /// <summary>
    /// Self-contained utility library for Starweaver's Grimoire.
    /// Includes easing functions, curve segments, palette helpers, and SpriteBatch extensions.
    /// </summary>
    public static class StarweaversGrimoireUtils
    {
        #region Color Palette — Starweaver's Grimoire

        /// <summary>Core 6-color palette: arcane void → star pattern white.</summary>
        public static readonly Color[] WeaponPalette = NachtmusikPalette.StarweaversGrimoireCast;
