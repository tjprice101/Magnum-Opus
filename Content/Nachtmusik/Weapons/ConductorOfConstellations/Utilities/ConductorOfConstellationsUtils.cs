...
{
    /// <summary>
    /// Self-contained utility library for Conductor of Constellations.
    /// Includes easing functions, curve segments, palette helpers, and SpriteBatch extensions.
    /// </summary>
    public static class ConductorOfConstellationsUtils
    {
        #region Color Palette — Conductor of Constellations

        /// <summary>Core 6-color palette: midnight void → conductor's white.</summary>
        public static readonly Color[] WeaponPalette = NachtmusikPalette.ConductorOfConstellationsMinion;
