...
{
    /// <summary>
    /// Self-contained utility library for Requiem of the Cosmos.
    /// Includes easing functions, curve segments, palette helpers, and SpriteBatch extensions.
    /// </summary>
    public static class RequiemOfTheCosmosUtils
    {
        #region Color Palette — Requiem of the Cosmos

        /// <summary>Core 6-color palette: cosmic void → cosmic white.</summary>
        public static readonly Color[] WeaponPalette = NachtmusikPalette.RequiemOfTheCosmosCast;
