...
{
    /// <summary>
    /// Nebula whisper shot -- scaffold based on BlackSwanFlareProj pattern.
    ...
    public class NebulaWhisperShot : ModProjectile
    {
        ...
        public override string Texture => "MagnumOpus/Content/Nachtmusik/Weapons/NebulasWhisper/NebulasWhisper";
