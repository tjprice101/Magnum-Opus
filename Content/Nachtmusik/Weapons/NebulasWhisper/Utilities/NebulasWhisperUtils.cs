...
{
    /// <summary>
    /// Self-contained utility library for Nebula's Whisper.
    /// Includes easing functions, curve segments, palette helpers, and SpriteBatch extensions.
    /// </summary>
    public static class NebulasWhisperUtils
    {
        #region Color Palette — Nebula Whisper

        /// <summary>Core 6-color palette: deep nebula → whisper white.</summary>
        public static readonly Color[] WeaponPalette = NachtmusikPalette.NebulasWhisperShot;
