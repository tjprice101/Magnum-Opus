...
{
    /// <summary>
    /// Self-contained utility library for Celestial Chorus Baton.
    /// Includes easing functions, curve segments, palette helpers, and SpriteBatch extensions.
    /// </summary>
    public static class CelestialChorusBatonUtils
    {
        #region Color Palette — Celestial Chorus Baton

        /// <summary>Core 6-color palette: night void → chorus white.</summary>
        public static readonly Color[] WeaponPalette = NachtmusikPalette.CelestialChorusMinion;
