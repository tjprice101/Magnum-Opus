...
{
    /// <summary>
    /// XSlashProjectile — Homing projectile that spawns a blazing X-slash on impact.
    /// 
    /// Behaviour:
    /// - Gentle homing toward nearest enemy after 10-frame delay
    /// - Additive bloom trail rendering
    /// - On hit or kill, spawns XSlashEffect at the impact point
    /// - 1 penetration then death
    /// 
    /// ai[0] = XSlashStyle index (determines X-slash colors)
    /// </summary>
    public class XSlashProjectile : ModProjectile
    {
        ...
        private XSlashStyle CurrentStyle => (XSlashStyle)(int)Projectile.ai[0];
        ...
        public override void AI()
        {
            ...
            // ---- LIGHTING ----
            Color[] colors = XSFTextures.GetStyleColors(CurrentStyle);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            // Outer glow
            sb.Draw(softGlow, drawPos, null, colors[0] * (0.25f * fadeIn * pulse),
                0f, glowOrigin, 0.12f * pulse, SpriteEffects.None, 0f);

            // Core glow
            sb.Draw(softGlow, drawPos, null, colors[2] * (0.45f * fadeIn * pulse),
        ...
        private void SpawnXSlashEffect(Vector2 position)
        {
            ...
            SoundEngine.PlaySound(SoundID.Item14 with { Volume = 0.7f, Pitch = 0.4f }, position);
        }

        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            SpawnXSlashEffect(target.Center);
        ...
        {
            SpawnXSlashEffect(Projectile.Center);
