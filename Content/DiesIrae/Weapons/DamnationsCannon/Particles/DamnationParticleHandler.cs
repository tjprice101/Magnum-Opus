...
{
    public class DamnationParticleHandler : ModSystem
    {
        private static readonly List<DamnationParticle> particles = new();
        private const int MaxParticles = 500;

        public static void Spawn(DamnationParticle p)
        {
