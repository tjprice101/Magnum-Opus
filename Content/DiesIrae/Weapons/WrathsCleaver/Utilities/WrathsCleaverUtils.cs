...
{
    /// <summary>
    /// Self-contained utility class for Wrath's Cleaver.
    /// Palette, easings, animation curves, SpriteBatch helpers, geometry helpers.
    /// Blood-soaked fury ascending from shadow to wrath — every swing is a sentence.
    /// </summary>
    public static class WrathsCleaverUtils
    {
        #region Color Palette

        /// <summary>Wrath's Cleaver blade palette — blood-soaked fury, ascending from shadow to wrath.</summary>
        public static readonly Color[] WeaponPalette = DiesIraePalette.WrathsCleaverBlade;
