...
{
    /// <summary>
    /// Self-contained utility class for Death Tolling Bell.
    /// Palette, easings, animation curves, SpriteBatch helpers, geometry helpers.
    /// Funeral bell, the toll of doom — solemn, ominous, inescapable.
    /// </summary>
    public static class DeathTollingBellUtils
    {
        #region Color Palette

        /// <summary>Death Tolling Bell aura palette — funeral bell, the toll of doom.</summary>
        public static readonly Color[] WeaponPalette = DiesIraePalette.DeathTollingBellAura;
        ...
        /// <summary>Gets a color along the weapon gradient (0=funeral shadow, 1=tolling flash).</summary>
