...
namespace MagnumOpus.Content.DiesIrae.Weapons.StaffOfFinalJudgment.Utilities
{
    /// <summary>
    /// Self-contained utility class for Staff of Final Judgment.
    ...
    /// </summary>
    public static class StaffOfFinalJudgmentUtils
    {
        #region Color Palette

        /// <summary>Staff of Final Judgment cast palette — divine condemnation, holy wrath.</summary>
        public static readonly Color[] WeaponPalette = DiesIraePalette.StaffOfFinalJudgmentCast;
