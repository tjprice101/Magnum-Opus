...
namespace MagnumOpus.Content.DiesIrae.Weapons.HarmonyOfJudgment.Utilities
{
    /// <summary>
    /// Self-contained utility class for Harmony of Judgment.
    /// Palette, easings, animation curves, SpriteBatch helpers, geometry helpers.
    /// Divine harmony turned to judgment — every chord condemns.
    /// </summary>
    public static class HarmonyOfJudgmentUtils
    {
        #region Color Palette

        /// <summary>Harmony of Judgment palette — divine harmony, ecclesiastical condemnation.</summary>
        public static readonly Color[] WeaponPalette = new Color[]
        {
            DiesIraePalette.CharcoalBlack,  // [0] Pianissimo — shadow of the condemned
            DiesIraePalette.DoomPurple,     // [1] Piano — ecclesiastical dread
            DiesIraePalette.BloodRed,       // [2] Mezzo — blood-stained harmony
            DiesIraePalette.JudgmentGold,   // [3] Forte — judgment gold chord
            DiesIraePalette.Parchment,      // [4] Fortissimo — parchment absolution
            DiesIraePalette.WrathWhite,     // [5] Sforzando — harmonic judgment flash
        };
        ...
        /// <summary>Gets a color along the weapon gradient (0=shadow, 1=judgment flash).</summary>
