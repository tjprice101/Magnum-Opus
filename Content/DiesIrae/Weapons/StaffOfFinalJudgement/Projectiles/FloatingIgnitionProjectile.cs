...
namespace MagnumOpus.Content.DiesIrae.Weapons.StaffOfFinalJudgement.Projectiles
{
    public class FloatingIgnitionProjectile : ModProjectile
    {
        ...
        public override string Texture => "MagnumOpus/Content/DiesIrae/Weapons/StaffOfFinalJudgement/StaffOfFinalJudgement";
        ...
        public override void AI()
        {
            ...
            NPC target = StaffOfFinalJudgementUtils.ClosestNPCAt(Projectile.Center, HomingRange);
            if (target != null)
            {
