...
{
    public class JudgementParticleHandler : ModSystem
    {
        private static readonly List<JudgementParticle> particles = new();
        private const int MaxParticles = 500;

        public static void Spawn(JudgementParticle p)
        {
