...
namespace MagnumOpus.Content.DiesIrae.Weapons.HarmonyOfJudgement.Projectiles
{
    public class JudgmentSigilMinion : ModProjectile
    {
        ...
        public override string Texture => "MagnumOpus/Content/DiesIrae/Weapons/HarmonyOfJudgement/HarmonyOfJudgement";
        ...
        public override void AI()
        {
            ...
            NPC target = HarmonyOfJudgementUtils.ClosestNPCAt(Projectile.Center, HomingRange);
            if (target != null)
            {
