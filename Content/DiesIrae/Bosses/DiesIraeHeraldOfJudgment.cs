...
namespace MagnumOpus.Content.DiesIrae.Bosses
{
    ...
    /// </summary>
    public class DiesIraeHeraldOfJudgment : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (State != BossPhase.Spawning && State != BossPhase.Death)
            {
                ...
                {
                    case 0: HeraldOfJudgmentVFX.SummoningAmbience(NPC.Center, Timer); break;
                    case 1: HeraldOfJudgmentVFX.TrialAmbience(NPC.Center, Timer); break;
                    default: HeraldOfJudgmentVFX.VerdictAmbience(NPC.Center, Timer); break;
                }
                if (isEnraged)
                    HeraldOfJudgmentVFX.EnrageAmbience(NPC.Center, Timer);
                HeraldOfJudgmentVFX.UpdateSkyPhase(difficultyTier, isEnraged);
            }
        }
        ...
        private void Attack_HellfireBarrage(Player target)
        {
            ...
            HeraldOfJudgmentVFX.ChargeUp(NPC.Center, chargeProgress, 1.2f);
            ...
            if (SubPhase < burstCount)
            {
                if (Timer == 5)
                {
                    ...
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 0.9f);
                    HeraldOfJudgmentVFX.GavelImpactRings(NPC.Center, 4, 0.8f);
        ...
        private void Attack_JudgmentRay(Player target)
        {
            ...
            if (SubPhase == 0) // Telegraph - DRAMATIC CHARGE UP
            {
                ...
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, progress, 1.5f);
                
                // Warning line toward player
                if (Timer % 5 == 0)
                {
                    Vector2 toTarget = (target.Center - NPC.Center).SafeNormalize(Vector2.UnitX);
                    HeraldOfJudgmentVFX.BurningScriptureTelegraph(NPC.Center, toTarget, 800f, 5);
                }
                ...
                if (Timer >= 50)
                {
                    ...
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 1.3f);
                }
            }
        ...
        private void Attack_InfernalRing(Player target)
        {
            ...
            if (SubPhase < rings && Timer < 10)
            {
                ...
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, Math.Min(1f, progress), 1f);
            }
            ...
            if (SubPhase < rings)
            {
                if (Timer == 10)
                {
                    ...
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 1.2f + SubPhase * 0.2f);
                    HeraldOfJudgmentVFX.GavelImpactRings(NPC.Center, 5 + SubPhase, 1f + SubPhase * 0.15f);
        ...
        private void Attack_CondemnationStrike(Player target)
        {
            ...
            if (SubPhase == 0) // Telegraph - DRAMATIC WARNING
            {
                ...
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, progress, 1.3f);
                
                if (Timer % 4 == 0)
                {
                    Vector2 toTarget = (target.Center - NPC.Center).SafeNormalize(Vector2.UnitX);
                    HeraldOfJudgmentVFX.BurningScriptureTelegraph(NPC.Center, toTarget, 750f, 4);
                }
            ...
            else if (SubPhase == 1) // Strikes - DEVASTATING DASHES
            {
                if (dashCount < strikeCount)
                {
                    if (Timer == 1)
                    {
                        ...
                        HeraldOfJudgmentVFX.FireImpact(NPC.Center, 1f);
                        MagnumScreenEffects.AddScreenShake(8f);
                    }
                    
                    // === FIRE TRAIL DURING DASH ===
                    HeraldOfJudgmentVFX.FireTrail(NPC.Center, NPC.velocity, 1.5f);
                    HeraldOfJudgmentVFX.FireTrail(NPC.Center + Main.rand.NextVector2Circular(20f, 20f), NPC.velocity, 1f);
                    ...
                    if (Timer >= 22)
                    {
                        ...
                        dashCount++;
                        NPC.velocity *= 0.25f;
                        HeraldOfJudgmentVFX.FireImpact(NPC.Center, 0.8f);
                        HeraldOfJudgmentVFX.GavelImpactRings(NPC.Center, 3, 0.7f);
                    }
                }
                else
                {
        ...
        private void Attack_SoulHarvest(Player target)
        {
            ...
            if (SubPhase == 0) // Spawn souls - DRAMATIC SUMMONING
            {
                ...
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, progress, 1.2f);
                
                if (Timer == 25)
                {
                    SoundEngine.PlaySound(SoundID.NPCDeath6 with { Pitch = -0.5f, Volume = 1.5f }, NPC.Center);
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 1.5f);
                    ...
                    if (Main.netMode != NetmodeID.MultiplayerClient)
                    {
                        for (int i = 0; i < soulCount; i++)
                        {
                            ...
                            HeraldOfJudgmentVFX.FireImpact(NPC.Center + spawnOffset, 0.5f);
                        }
                    }
                }
        ...
        private void Attack_WrathfulDescent(Player target)
        {
            if (SubPhase == 0) // Rise up - OMINOUS ASCENT
            {
                ...
                HeraldOfJudgmentVFX.FireTrail(NPC.Center, NPC.velocity, 1.2f);
            ...
            else if (SubPhase == 1) // Telegraph - DRAMATIC PAUSE
            {
                ...
                if (Timer % 3 == 0)
                {
                    for (int i = 0; i < 12; i++)
                    {
                        ...
                        HeraldOfJudgmentVFX.WarningFlare(warningPos, 0.6f);
                    }
                }
            ...
            else if (SubPhase == 2) // Descent - DEVASTATING DIVE
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    HeraldOfJudgmentVFX.FireTrail(NPC.Center + Main.rand.NextVector2Circular(30f, 30f), NPC.velocity, 1.5f);
                }
                ...
                if (Timer >= 35 || NPC.Center.Y > dashTarget.Y + 150f)
                {
                    ...
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 2f);
        ...
        private void Attack_ChainOfDamnation(Player target)
        {
            ...
            {
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, Timer / 10f, 0.8f);
            }
            ...
            if (SubPhase < chainLength)
            {
                if (Timer == 10)
                {
                    ...
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 0.7f);
        ...
        private void Attack_ApocalypseRain(Player target)
        {
            ...
            HeraldOfJudgmentVFX.FireTrail(NPC.Center + Main.rand.NextVector2Circular(40f, 40f), Vector2.Zero, 0.8f);
            ...
            if (Timer % fireRate == 0 && Timer > 20 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                for (int p = 0; p < projectilesPerWave; p++)
                {
                    ...
                    HeraldOfJudgmentVFX.WarningFlare(new Vector2(spawnPos.X, target.Center.Y), 0.4f);
                }
            }
        ...
        private void Attack_FinalJudgment(Player target)
        {
            ...
            if (SubPhase == 0) // Charge - APOCALYPTIC BUILDUP
            {
                ...
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, progress, 2f);
            ...
            else if (SubPhase <= waveCount) // Radial bursts with safe arc - DEVASTATING WAVES
            {
                if (Timer == 1)
                {
                    ...
                    HeraldOfJudgmentVFX.FireImpact(NPC.Center, 1.3f + SubPhase * 0.15f);
        ...
        private void Attack_DivinePunishment(Player target)
        {
            ...
            if (SubPhase == 0) // Dramatic charge - APOCALYPTIC BUILDUP
            {
                ...
                HeraldOfJudgmentVFX.ChargeUp(NPC.Center, progress, 2.5f);
                ...
                if (Timer % 5 == 0)
                {
                    for (int i = 0; i < 8; i++)
                    {
                        ...
                        HeraldOfJudgmentVFX.FireImpact(auraPos, 0.4f);
                    }
                }
            ...
            else if (SubPhase == 2) // Execute dashes
            {
                if (dashCount < 6)
                {
                    ...
                    for (int i = 0; i < 2; i++)
                    {
                        HeraldOfJudgmentVFX.FireTrail(NPC.Center + Main.rand.NextVector2Circular(25f, 25f), NPC.velocity, 1.3f);
                    }
            ...
            else if (SubPhase == 3) // Final explosion - CATACLYSMIC FINALE
            {
                ...
                if (Timer == 25)
                {
                    ...
                    HeraldOfJudgmentVFX.DeathExplosion(NPC.Center, 1.2f);
        ...
        private void UpdateDeathAnimation()
        {
            ...
            if (deathTimer % 8 == 0)
            {
                HeraldOfJudgmentVFX.FireImpact(NPC.Center + Main.rand.NextVector2Circular(50f * deathProgress, 50f * deathProgress), 0.6f + deathProgress * 0.8f);
            }
            ...
            if (deathTimer % 3 == 0)
            {
                for (int i = 0; i < 3; i++)
                {
                    HeraldOfJudgmentVFX.FireTrail(NPC.Center + Main.rand.NextVector2Circular(80f, 80f), Main.rand.NextVector2Circular(3f, 3f), 1f + deathProgress);
                }
            }
            ...
            if (deathTimer % 12 == 0)
            {
                ...
                HeraldOfJudgmentVFX.SpawnMusicNote(NPC.Center + Main.rand.NextVector2Circular(40f, 40f), noteVel, Color.White, 1f);
            }
            ...
            if (deathTimer == 160)
            {
                ...
                HeraldOfJudgmentVFX.DeathExplosion(NPC.Center, 2f);
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            int[] weapons = new int[]
            {
                ...
                ModContent.ItemType<StaffOfFinalJudgment>(),
