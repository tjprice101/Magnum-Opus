...
{
    /// <summary>
    /// Staccato bullet wrapper 驕ｯ・ｶ郢晢ｽｻreplaces vanilla bullets with fire-trail-enhanced versions.
    ...
    public class StaccatoBulletProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // Fire ember trail 窶・frequent hot sparks scattering from the bullet
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            // === FOUNDATION: RippleEffectProjectile 窶・Marker embed ring ===
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (trailPositions.Count >= 2)
            {
                try
                {
                    ...
                    // === SHADER: BulletTrailShader 窶・supersonic compression-wave trail ===
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            // Impact spark burst 窶・radial scatter of 8 tracers
            for (int i = 0; i < 8; i++)
            {
