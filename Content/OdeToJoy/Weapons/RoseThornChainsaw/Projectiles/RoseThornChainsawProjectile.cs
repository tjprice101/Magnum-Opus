...
namespace MagnumOpus.Content.OdeToJoy.Weapons.RoseThornChainsaw.Projectiles
{
    ...
    /// Rose pink trail with scattered petal dust and golden pollen highlights.
    /// </summary>
    public class RoseThornChainsawProjectile : ExobladeStyleSwing
    {
        ...
        protected override Color SlashPrimaryColor => new Color(230, 120, 150);
        protected override Color SlashSecondaryColor => new Color(60, 20, 30);
        protected override Color SlashAccentColor => new Color(255, 200, 60);
        ...
        protected override Color GetSwingDustColor()
        {
            ...
            return t < 0.5f
                ? Color.Lerp(new Color(220, 110, 140), new Color(240, 160, 180), Main.rand.NextFloat())
                : Color.Lerp(new Color(200, 100, 130), new Color(255, 200, 60), Main.rand.NextFloat());
        }
