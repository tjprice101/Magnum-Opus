...
{
    /// <summary>
    /// Self-contained particle handler for The Pollinator.
    ...
    public sealed class PollinatorParticleHandler : ModSystem
    {
        private static List<PollinatorParticle> activeParticles;
        private static List<PollinatorParticle> particlesToRemove;
        private const int ParticleLimit = 500;

        public override void Load()
        {
            activeParticles = new List<PollinatorParticle>(ParticleLimit);
            particlesToRemove = new List<PollinatorParticle>();
        ...
        public static void SpawnParticle(PollinatorParticle particle)
        {
