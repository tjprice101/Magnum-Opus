...
{
    /// <summary>
    /// Self-contained particle handler for the Fountain of Joyous Harmony.
    ...
    public sealed class FountainParticleHandler : ModSystem
    {
        private static List<FountainParticle> activeParticles;
        private static List<FountainParticle> particlesToRemove;
        private const int ParticleLimit = 500;

        public override void Load()
        {
            activeParticles = new List<FountainParticle>(ParticleLimit);
            particlesToRemove = new List<FountainParticle>();
        ...
        public static void SpawnParticle(FountainParticle particle)
        {
