...
namespace MagnumOpus.Content.OdeToJoy.Weapons.FountainOfJoyousHarmony
{
    public class FountainOfJoyousHarmony : ModItem
    {
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            spriteBatch.Draw(tex, drawPos, null, OdeToJoyPalette.VerdantGreen with { A = 0 } * pulse, rotation, origin, scale * 1.05f, SpriteEffects.None, 0f);
            spriteBatch.Draw(tex, drawPos, null, OdeToJoyPalette.PetalPink with { A = 0 } * (pulse * 0.5f), rotation, origin, scale * 1.02f, SpriteEffects.None, 0f);
        }
