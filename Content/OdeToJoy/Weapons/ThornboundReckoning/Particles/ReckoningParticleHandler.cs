...
{
    /// <summary>
    /// Self-contained particle handler for Thornbound Reckoning.
    ...
    public sealed class ReckoningParticleHandler : ModSystem
    {
        private static List<ReckoningParticle> activeParticles;
        private static List<ReckoningParticle> particlesToRemove;
        private const int ParticleLimit = 500;

        public override void Load()
        {
            activeParticles = new List<ReckoningParticle>(ParticleLimit);
            particlesToRemove = new List<ReckoningParticle>();
        ...
        public static void SpawnParticle(ReckoningParticle particle)
        {
