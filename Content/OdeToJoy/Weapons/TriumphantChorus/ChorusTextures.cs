...
namespace MagnumOpus.Content.OdeToJoy.Weapons.TriumphantChorus
{
    ...
    public static class ChorusTextures
    {
        ...
        // Per-voice colors
        public static readonly Color SopranoColor = new Color(255, 250, 200); // Jubilant Light  Ehighest
        public static readonly Color AltoColor = new Color(255, 200, 50);     // Bloom Gold  Ewarm mid
        public static readonly Color TenorColor = new Color(255, 170, 40);   // Radiant Amber  Edeeper
        public static readonly Color BassColor = new Color(220, 100, 120);   // Petal Pink  Edeepest/warmest
