...
namespace MagnumOpus.Content.OdeToJoy.Weapons.PetalStormCannon
{
    ...
    /// MaskFoundation primary — persistent vortex zones with CosmicVortex noise.
    /// </summary>
    public static class PetalStormTextures
    {
        ...
        public static Texture2D NoiseVortex => (_noiseVortex ??= ModContent.Request<Texture2D>("MagnumOpus/Assets/VFX/Noise/TileableCosmicVortexNoise", AssetRequestMode.ImmediateLoad)).Value;
        ...
        // Seasonal petal colors: pink → gold → white cycle
