...
{
    /// <summary>
    /// Self-contained particle handler for the Petal Storm Cannon.
    ...
    public sealed class PetalStormParticleHandler : ModSystem
    {
        private static List<PetalStormParticle> activeParticles;
        private static List<PetalStormParticle> particlesToRemove;
        private const int ParticleLimit = 600;

        public override void Load()
        {
            activeParticles = new List<PetalStormParticle>(ParticleLimit);
            particlesToRemove = new List<PetalStormParticle>();
        ...
        public static void SpawnParticle(PetalStormParticle particle)
        {
