...
{
    /// <summary>
    /// Self-contained particle handler for the Thorn Spray Repeater.
    ...
    public sealed class ThornSprayParticleHandler : ModSystem
    {
        private static List<ThornSprayParticle> activeParticles;
        private static List<ThornSprayParticle> particlesToRemove;
        private const int ParticleLimit = 500;

        public override void Load()
        {
            activeParticles = new List<ThornSprayParticle>(ParticleLimit);
            particlesToRemove = new List<ThornSprayParticle>();
        ...
        public static void SpawnParticle(ThornSprayParticle particle)
        {
