...
{
    /// <summary>
    /// Self-contained particle handler for Anthem of Glory.
    ...
    public sealed class AnthemParticleHandler : ModSystem
    {
        private static List<AnthemParticle> activeParticles;
        private static List<AnthemParticle> particlesToRemove;
        private const int ParticleLimit = 500;

        public override void Load()
        {
            activeParticles = new List<AnthemParticle>(ParticleLimit);
            particlesToRemove = new List<AnthemParticle>();
        ...
        public static void SpawnParticle(AnthemParticle particle)
        {
