...
namespace MagnumOpus.Content.Eroica.Projectiles
{
    ...
    public class HandOfValor : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            EroicaVFXLibrary.BloomFlare(Projectile.Center, EroicaPalette.Gold * pulse, 0.35f, 5);
            ...
            if (Projectile.timeLeft % 6 == 0)
            {
                for (int i = 0; i < 3; i++)
                {
                    ...
                    Color orbitColor = Color.Lerp(EroicaPalette.Crimson, EroicaPalette.Gold, (float)i / 3f);
                    EroicaVFXLibrary.BloomFlare(orbitPos, orbitColor, 0.22f, 8);
                }
            }
            ...
            {
                EroicaVFXLibrary.SpawnSakuraPetals(Projectile.Center, 1, 18f);
            }
            ...
            if (Main.rand.NextBool(8))
            {
                ...
                EroicaVFXLibrary.SpawnMusicNote(Projectile.Center, noteVel, noteColor, 0.25f, 20);
            }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            EroicaVFXLibrary.DeathHeroicFlash(Projectile.Center, 1.0f);
            for (int i = 0; i < 3; i++)
            {
                ...
                Color noteColor = Color.Lerp(EroicaPalette.Gold, EroicaPalette.Sakura, (float)i / 3f);
                EroicaVFXLibrary.SpawnMusicNote(notePos, noteVel, noteColor, 0.28f, 22);
            }
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            EroicaVFXLibrary.BloomFlare(target.Center, Color.White, 0.8f, 12);
            EroicaVFXLibrary.BloomFlare(target.Center, EroicaPalette.Crimson, 0.6f, 15);
            
            // === Eroica themed impact ===
            EroicaVFXLibrary.HeroicImpact(target.Center, 0.9f);
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                EroicaVFXLibrary.BloomFlare(target.Center + flareOffset, fractalColor, 0.35f, 12);
            }
            ...
            // === Sakura petals ===
            EroicaVFXLibrary.SpawnSakuraPetals(target.Center, 2, 28f);
            
            // === Halo ring ===
            EroicaVFXLibrary.SpawnGradientHaloRings(target.Center, 1, 0.35f);
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            try
            {
                for (int k = 0; k < Projectile.oldPos.Length; k++)
                {
                    ...
                    Color outerColor = EroicaPalette.Scarlet * trailAlpha * 0.35f;
                    ...
                    Color midColor = EroicaPalette.Gold * trailAlpha * 0.4f;
                    ...
                    Color innerColor = Color.Lerp(EroicaPalette.Flame, EroicaPalette.Sakura, trailProgress) * trailAlpha * 0.5f;
                    ...
                    if (k % 2 == 0)
                    {
                        Color textureTrailColor = Color.Lerp(EroicaPalette.Gold, EroicaPalette.Crimson, trailProgress) * trailAlpha * 0.6f;
