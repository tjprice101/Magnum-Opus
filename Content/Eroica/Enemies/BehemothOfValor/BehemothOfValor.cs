...
namespace MagnumOpus.Content.Eroica.Enemies.BehemothOfValor
{
    ...
    public class BehemothOfValor : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Effect auraShader = EnemyShaderManager.GetShader(EnemyShaderManager.BehemothWarAura);
            if (auraShader != null)
            {
            ...
            {
                Effect trailShader = EnemyShaderManager.GetShader(EnemyShaderManager.BehemothSlamWave);
                if (trailShader != null)
                {
