...
namespace MagnumOpus.Content.Eroica.Weapons.PiercingLightOfTheSakura.Primitives
{
    public static class PiercingTrailRenderer
    {
        ...
        public static void RenderTrail(Vector2[] positions, PiercingTrailSettings settings, int maxPointCount = 40)
        {
            ...
            if (_vertexBuffer == null || _vertexBuffer.IsDisposed)
                _vertexBuffer = new DynamicVertexBuffer(device, PiercingVertexType._vertexDeclaration, MaxVertices, BufferUsage.WriteOnly);
            ...
            PiercingVertexType[] vertices = new PiercingVertexType[vertexCount];
            ...
            for (int i = 0; i < pointCount; i++)
            {
                ...
                vertices[i * 2] = new PiercingVertexType(worldPos + normal * width * 0.5f, color, new Vector3(completion, 0f, width));
                vertices[i * 2 + 1] = new PiercingVertexType(worldPos - normal * width * 0.5f, color, new Vector3(completion, 1f, width));
            }
