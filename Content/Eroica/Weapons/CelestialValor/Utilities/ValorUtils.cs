...
{
    public static class ValorUtils
    {
        #region Heroic Palette — Eroica Scarlet→Gold fire gradient

        public static readonly Color BlackSmoke = new Color(20, 8, 8);
        public static readonly Color DeepScarlet = new Color(120, 18, 18);
        public static readonly Color Scarlet = new Color(200, 40, 40);
        public static readonly Color CrimsonFlame = new Color(230, 70, 20);
        public static readonly Color Flame = new Color(255, 100, 50);
        public static readonly Color Gold = new Color(255, 200, 50);
        public static readonly Color SakuraPink = new Color(255, 160, 185);
        public static readonly Color HotCore = new Color(255, 240, 200);
        public static readonly Color WhiteFlash = new Color(255, 252, 248);
        public static readonly Color HeroicBlaze = new Color(255, 120, 40);

        // Aliases used by CelestialValorSwing
        public static Color ScarletEmber => Scarlet;
        public static Color GoldenFlare => Gold;
        public static Color CrimsonHeart => CrimsonFlame;
        public static Color FlameOrange => Flame;
        public static Color SakuraPetal => SakuraPink;

        public static readonly Color[] HeroicPalette = new Color[]
        {
            BlackSmoke, DeepScarlet, Scarlet, CrimsonFlame, Gold, SakuraPink, HotCore, WhiteFlash
        };
        ...
        public static Color GetFireGradient(float t)
        {
            return MulticolorLerp(t, DeepScarlet, Scarlet, CrimsonFlame, Gold, HotCore);
        }

        public static Color GetHeroicGradient(float t, float whitePush = 0f)
        {
            Color base_ = MulticolorLerp(t, HeroicPalette);
            return Color.Lerp(base_, WhiteFlash, whitePush);
        }

        public static Color GetElementColor(float t, Color[] palette)
        {
            ...
            return Color.Lerp(palette[idx], palette[Math.Min(idx + 1, palette.Length - 1)], frac);
        }
        ...
        public static void BeginAdditive(this SpriteBatch spriteBatch, Matrix? matrix = null)
        {
            spriteBatch.End();
        ...
        public static void RestoreSpriteBatch(this SpriteBatch spriteBatch, Matrix? matrix = null)
        {
            spriteBatch.End();
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend,
                Main.DefaultSamplerState, DepthStencilState.None, Main.Rasterizer,
        ...
        public static NPC ClosestNPCAt(this Vector2 origin, float maxDistance, bool ignoreTiles = true, bool bossPriority = false)
        {
            NPC closest = null;
        ...
        public static void DoLifestealDirect(this Player player, NPC target, int amount, float cooldownMult = 1f)
        {
