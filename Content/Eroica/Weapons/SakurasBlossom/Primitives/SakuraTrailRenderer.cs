...
namespace MagnumOpus.Content.Eroica.Weapons.SakurasBlossom.Primitives
{
    public static class SakuraTrailRenderer
    {
        ...
        public static void RenderTrail(Vector2[] positions, SakuraTrailSettings settings, int maxPointCount = 40)
        {
            ...
            if (_vertexBuffer == null || _vertexBuffer.IsDisposed)
                _vertexBuffer = new DynamicVertexBuffer(device, SakuraVertexType._vertexDeclaration, MaxVertices, BufferUsage.WriteOnly);
            ...
            SakuraVertexType[] vertices = new SakuraVertexType[vertexCount];
            ...
            for (int i = 0; i < pointCount; i++)
            {
                ...
                vertices[i * 2] = new SakuraVertexType(worldPos + normal * width * 0.5f, color, new Vector3(completion, 0f, width));
                vertices[i * 2 + 1] = new SakuraVertexType(worldPos - normal * width * 0.5f, color, new Vector3(completion, 1f, width));
            }
