...
namespace MagnumOpus.Content.Eroica.Weapons.SakurasBlossom.Particles
{
    ...
    public class SakuraParticleHandler : ModSystem
    {
        private static readonly List<SakuraParticle> _particles = new();
        ...
        public static void SpawnParticle(SakuraParticle particle)
        {
