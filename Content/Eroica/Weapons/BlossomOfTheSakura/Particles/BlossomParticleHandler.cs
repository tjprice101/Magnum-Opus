...
namespace MagnumOpus.Content.Eroica.Weapons.BlossomOfTheSakura.Particles
{
    ...
    public class BlossomParticleHandler : ModSystem
    {
        private static readonly List<BlossomParticle> _particles = new();
        ...
        public static void SpawnParticle(BlossomParticle particle)
        {
        ...
        private void DrawParticles(On_Main.orig_DrawDust orig, Main self)
        {
            ...
            // Pass 1: Additive particles (tracers, muzzle flash, bloom)
            ...
            // Pass 2: Alpha blend particles (heat shimmer, petals)
