...
namespace MagnumOpus.Content.Eroica.Weapons.BlossomOfTheSakura.Utilities
{
    ...
    {
        #region Heat-Reactive Palette — cool sakura pinks through crimson to white-hot gold

        public static readonly Color CoolPetal = new Color(255, 180, 210);
        public static readonly Color SakuraBody = new Color(255, 130, 160);
        public static readonly Color WarmCrimson = new Color(220, 55, 55);
        public static readonly Color HeatOrange = new Color(255, 140, 40);
        public static readonly Color HotBarrel = new Color(255, 200, 80);
        public static readonly Color WhiteHot = new Color(255, 245, 220);
        public static readonly Color MuzzleFlash = new Color(255, 235, 200);
        public static readonly Color TracerCore = new Color(255, 220, 180);

        public static readonly Color[] BlossomPalette = new Color[]
        {
            CoolPetal, SakuraBody, WarmCrimson, HeatOrange, HotBarrel, WhiteHot, MuzzleFlash, TracerCore
        };
        ...
        /// <summary>
        /// Heat gradient: CoolPetal -> SakuraBody -> WarmCrimson -> HeatOrange -> HotBarrel -> WhiteHot.
        /// heatProgress 0 = cool sakura pink, 1 = white-hot gold.
        /// </summary>
        public static Color GetHeatGradient(float heatProgress)
        {
            return MulticolorLerp(heatProgress, CoolPetal, SakuraBody, WarmCrimson, HeatOrange, HotBarrel, WhiteHot);
        }

        public static Color GetTracerGradient(float t)
        {
            return MulticolorLerp(t, TracerCore, HotBarrel, HeatOrange, WarmCrimson, SakuraBody);
        }

        public static Color GetBlossomGradient(float t, float whitePush = 0f)
        {
            Color base_ = MulticolorLerp(t, BlossomPalette);
            return Color.Lerp(base_, WhiteHot, whitePush);
        }
