...
namespace MagnumOpus.Content.Eroica.Weapons.FuneralPrayer.Primitives
{
    public static class FuneralTrailRenderer
    {
        ...
        public static void RenderTrail(Vector2[] positions, FuneralTrailSettings settings, int maxPointCount = 40)
        {
            ...
            if (_vertexBuffer == null || _vertexBuffer.IsDisposed)
                _vertexBuffer = new DynamicVertexBuffer(device, FuneralVertexType._vertexDeclaration, MaxVertices, BufferUsage.WriteOnly);
            ...
            FuneralVertexType[] vertices = new FuneralVertexType[vertexCount];
            ...
            for (int i = 0; i < pointCount; i++)
            {
                ...
                vertices[i * 2] = new FuneralVertexType(worldPos + normal * width * 0.5f, color, new Vector3(completion, 0f, width));
                vertices[i * 2 + 1] = new FuneralVertexType(worldPos - normal * width * 0.5f, color, new Vector3(completion, 1f, width));
            }
