...
namespace MagnumOpus.Content.Eroica.Weapons.FuneralPrayer.Particles
{
    ...
    public class FuneralParticleHandler : ModSystem
    {
        private static readonly List<FuneralParticle> _particles = new();
        ...
        public static void SpawnParticle(FuneralParticle particle)
        {
        ...
        private void DrawParticles(On_Main.orig_DrawDust orig, Main self)
        {
            ...
            // Pass 1: Additive particles (flames, sparks, bloom)
