...
namespace MagnumOpus.Content.Eroica.Weapons.TriumphantFractal.Primitives
{
    public static class FractalTrailRenderer
    {
        ...
        public static void RenderTrail(Vector2[] positions, FractalTrailSettings settings, int maxPointCount = 40)
        {
            ...
            if (_vertexBuffer == null || _vertexBuffer.IsDisposed)
                _vertexBuffer = new DynamicVertexBuffer(device, FractalVertexType._vertexDeclaration, MaxVertices, BufferUsage.WriteOnly);
            ...
            FractalVertexType[] vertices = new FractalVertexType[vertexCount];
            ...
            for (int i = 0; i < pointCount; i++)
            {
                ...
                vertices[i * 2] = new FractalVertexType(worldPos + normal * width * 0.5f, color, new Vector3(completion, 0f, width));
                vertices[i * 2 + 1] = new FractalVertexType(worldPos - normal * width * 0.5f, color, new Vector3(completion, 1f, width));
            }
