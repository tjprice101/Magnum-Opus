...
{
    /// <summary>
    /// Custom vertex type for Light of the Future trail rendering.
    /// Position (2D) + Color + UV (3-component: U, V, Width for cross-section correction).
    /// </summary>
    public struct LightVertexType : IVertexType
    {
        ...
        public LightVertexType(Vector2 position, Color color, Vector3 uv)
        {
            Position = position;
            Color = color;
