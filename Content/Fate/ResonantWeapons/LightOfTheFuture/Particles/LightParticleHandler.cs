...
{
    /// <summary>
    /// Self-contained particle handler for Light of the Future.
    /// Two-pass rendering: additive glows first, then alpha-blended notes/glyphs.
    /// </summary>
    [Autoload(Side = ModSide.Client)]
    public class LightParticleHandler : ModSystem
    {
        private static readonly List<LightParticle> _particles = new();
        private const int MaxParticles = 800;

        public static void SpawnParticle(LightParticle p)
        {
