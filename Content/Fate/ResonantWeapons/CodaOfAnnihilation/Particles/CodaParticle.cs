...
{
    /// <summary>
    /// Lightweight particle struct for all Coda of Annihilation effects.
    /// Self-contained — no dependency on shared mod particle infrastructure.
    /// </summary>
    public abstract class CodaParticle
    {
        public int Time;
        public int Lifetime;
