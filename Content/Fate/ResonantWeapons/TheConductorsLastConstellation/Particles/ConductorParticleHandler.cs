...
{
    /// <summary>
    /// Self-contained particle handler for The Conductor's Last Constellation.
    /// Two-pass rendering: additive glows first, then alpha-blended sprites.
    /// </summary>
    [Autoload(Side = ModSide.Client)]
    public class ConductorParticleHandler : ModSystem
    {
        private static readonly List<ConductorParticle> _particles = new();
        private const int MaxParticles = 800;

        public static void SpawnParticle(ConductorParticle p)
        {
