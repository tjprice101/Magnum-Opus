...
{
    /// <summary>
    /// Custom vertex type for Conductor trail rendering.
    /// Position (2D) + Color + UV (3-component: U, V, Width for cross-section correction).
    /// </summary>
    public struct ConductorVertexType : IVertexType
    {
        ...
        public ConductorVertexType(Vector2 position, Color color, Vector3 uv)
        {
            Position = position;
            Color = color;
