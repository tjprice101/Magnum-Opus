...
{
    /// <summary>
    /// GPU primitive trail renderer for The Conductor's Last Constellation.
    ...
    public class ConductorTrailRenderer : ModSystem
    {
        ...
        /// </summary>
        public static void RenderTrail(Vector2[] points, ConductorTrailSettings settings, int pointCount, int smoothing = 2)
        {
            EnsureInitialized();
            ...
            var vertices = new ConductorVertexType[vertexCount];
            ...
            for (int i = 0; i < smoothedCount; i++)
            {
                ...
                vertices[i * 2] = new ConductorVertexType(
                    pos + normal * width * 0.5f,
                    color,
                    new Vector3(progress, 0f, width));

                vertices[i * 2 + 1] = new ConductorVertexType(
                    pos - normal * width * 0.5f,
                    color,
