...
{
    /// <summary>
    /// Self-contained particle handler for Opus Ultima.
    /// Two-pass rendering: additive glows first, then alpha-blended notes/glyphs.
    /// </summary>
    [Autoload(Side = ModSide.Client)]
    public class OpusParticleHandler : ModSystem
    {
        private static readonly List<OpusParticle> _particles = new();
        private const int MaxParticles = 800;

        public static void SpawnParticle(OpusParticle p)
        {
