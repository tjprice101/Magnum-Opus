...
{
    /// <summary>
    /// GPU primitive trail renderer for Opus Ultima.
    ...
    public class OpusTrailRenderer : ModSystem
    {
        ...
        /// </summary>
        public static void RenderTrail(Vector2[] points, OpusTrailSettings settings, int pointCount, int smoothing = 2)
        {
            EnsureInitialized();
            ...
            var vertices = new OpusVertexType[vertexCount];
            ...
            for (int i = 0; i < smoothedCount; i++)
            {
                ...
                vertices[i * 2] = new OpusVertexType(
                    pos + normal * width * 0.5f,
                    color,
                    new Vector3(progress, 0f, width));

                vertices[i * 2 + 1] = new OpusVertexType(
                    pos - normal * width * 0.5f,
                    color,
