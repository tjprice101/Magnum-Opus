    ...
    public class SymphonysEndItem : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            tooltips.Add(new TooltipLine(Mod, "Effect1",
                "Unleashes spiraling spectral blades that corkscrew toward the cursor"));
            tooltips.Add(new TooltipLine(Mod, "Effect2",
                "Blades accelerate and deal more damage at high velocity"));
            tooltips.Add(new TooltipLine(Mod, "Effect3",
                "On impact, blades shatter into scattering blade fragments"));
            tooltips.Add(new TooltipLine(Mod, "Lore",
                "'The final movement — where every melody finds its end'")
            {
            ...
            Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            Projectile.NewProjectile(source, spawnPos, spiralVel, type, damage, knockback,
