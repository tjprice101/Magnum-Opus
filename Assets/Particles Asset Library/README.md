...
> **⭁ECRITICAL FOR AI ASSISTANTS: Always run `list_dir` on this folder to discover ALL available particles before creating weapon effects!**

This folder contains **106 particle textures** organized by category. Mix and match for unique weapon identities!

---

## ⚠�E�EMANDATORY: Particle Discovery Protocol
...
> ⚠�E�E**WARNING: Music notes at scale 0.25-0.4f are INVISIBLE! Use 0.6f minimum!**
...
### ❁EWRONG - Boring, repetitive, same as every other weapon
```csharp
...
### ✁ERIGHT - Unique visual identity with mixed particles
```csharp
