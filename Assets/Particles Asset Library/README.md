# Custom Particle Textures - COMPLETE CATALOG

> **箝・CRITICAL FOR AI ASSISTANTS: Always run `list_dir` on this folder to discover ALL available particles before creating weapon effects!**

This folder contains **106 particle textures** organized by category. Mix and match for unique weapon identities!

---

## 笞・・MANDATORY: Particle Discovery Protocol
...
## 投 Code Array Reference (CustomParticleSystem.cs)
...
### 七 Music Notes (6) - **THIS IS A MUSIC MOD!**
| File | Array Reference | Scale Range |
|------|-----------------|-------------|
...
> 笞・・**WARNING: Music notes at scale 0.25-0.4f are INVISIBLE! Use 0.6f minimum!**

### 笨ｨ Twilight Sparkles (3)
| File | Array Reference | Scale Range |
|------|-----------------|-------------|
...
### 笨ｨ Magic Sparkle Fields (8 available, numbered 4,6-12)
| File | Array Reference | Scale Range |
|------|-----------------|-------------|
...
### 決 Prismatic Sparkles (3 available: 11, 13, 14)
| File | Array Reference | Scale Range |
|------|-----------------|-------------|
...
## Code Examples - CREATIVE COMBINATIONS

### 笶・WRONG - Boring, repetitive, same as every other weapon
```csharp
CustomParticles.GenericFlare(position, color, 0.5f, 15);
CustomParticles.HaloRing(position, color, 0.3f, 12);
// This looks identical to 50 other weapons!
```

### 笨・RIGHT - Unique visual identity with mixed particles
```csharp
...
## 搭 PARTICLE SELECTION CHECKLIST
...
- [ ] **Vanilla Dust** combined with custom particles for density
    ...
    CustomParticles.PrismaticSparkle(pos, rainbow, 0.5f, variant: 12);
    
    // Energy flare core (variant 5)
    CustomParticles.EnergyFlare(pos, color, 0.6f, variant: 5);
}
```
...
All textures are **WHITE/GRAYSCALE** and get tinted at runtime:
...
> **IMPORTANT: When new particle textures are added to this folder, UPDATE THIS README!**

Add new entries including:
- Filename or file pattern
- Number of variants (if applicable)
