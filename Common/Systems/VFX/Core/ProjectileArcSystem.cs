...
namespace MagnumOpus.Common.Systems.VFX.Core
{
    ...
    public static class ProjectileArcSystem
    {
        ...
        public static void DrawAll(SpriteBatch spriteBatch)
        {
            ...
            Texture2D pixel = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Orbs/SoftGlow", 
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Orbs/SoftGlow",
                ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
