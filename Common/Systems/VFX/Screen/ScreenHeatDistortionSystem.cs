...
namespace MagnumOpus.Common.Systems.VFX
{
    ...
    public class ScreenHeatDistortionSystem : ModSystem
    {
        ...
        public override void Load()
        {
            ...
            // DISABLED: Hook conflicts with FancyLighting mod - causes SpriteBatch crash
        ...
        private void HookRenderPass(On_Main.orig_DoDraw orig, Main self, GameTime gameTime)
        {
            ...
            // DISABLED: Conflicts with other mods (FancyLighting) that hook into DoDraw
            // The SpriteBatch state is unpredictable after orig() returns
            // TODO: Re-enable when we have proper SpriteBatch state tracking
        ...
        private void ApplyDistortionPass()
        {
            ...
            try
            {
                ...
                // Apply shader (skip if a SpriteBatch is already in progress)
                spriteBatch.Begin(
            ...
            {
                // Silently handle - distortion is optional visual effect
            }
            finally
            {
                if (begunSpriteBatch)
