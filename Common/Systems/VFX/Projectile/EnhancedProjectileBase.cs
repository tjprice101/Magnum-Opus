...
namespace MagnumOpus.Common.Systems.VFX
{
    ...
    public abstract class EnhancedProjectileBase : ModProjectile
    {
        ...
        private void DrawBloomLayers()
        {
            ...
            Texture2D softGlow = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Orbs/SoftGlow", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            Texture2D flare = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Pixel/Flare", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            ...
            sb.Draw(softGlow, drawPos, null, outerGlow, 0f, glowOrigin, MathHelper.Min(baseScale * pulse * 2.0f, 0.293f), SpriteEffects.None, 0f);
            
            // Middle layer
            Color middleGlow = secondaryColor.WithoutAlpha() * 0.4f * BloomIntensity;
            sb.Draw(softGlow, drawPos, null, middleGlow, 0f, glowOrigin, MathHelper.Min(baseScale * pulse * 1.4f, 0.293f), SpriteEffects.None, 0f);
        ...
        private void DrawBezierTrail()
        {
            ...
            for (int i = 0; i < smoothTrail.Length; i++)
            {
                ...
                sb.Draw(softGlow, drawPos, null, trailColor, 0f, origin, MathHelper.Min(scale, 0.293f), SpriteEffects.None, 0f);
            }
