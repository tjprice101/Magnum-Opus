...
namespace MagnumOpus.Common.Systems
{
    ...
    public class MagnumOpusMenu : ModMenu
    {
        ...
        {
            Texture2D glowTex = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Pixel/Flare", AssetRequestMode.ImmediateLoad).Value;
            Texture2D flareTex = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Pixel/Flare", AssetRequestMode.ImmediateLoad).Value;
        ...
        private void DrawVignette(SpriteBatch spriteBatch)
        {
            ...
            Texture2D pixel = ModContent.Request<Texture2D>("MagnumOpus/Assets/SandboxLastPrism/Pixel/Flare", AssetRequestMode.ImmediateLoad).Value;
