...
*A golden and dark purple treasure bag for Nachtmusik, Queen of Radiance. Features dark purple fabric with golden starlit melody accents, radiating golden twinkling energy and sweet song particles.*

### PROMPT: Nachtmusik Treasure Bag

```
pixel art treasure bag sprite terraria style, nachtmusik golden starlit melody theme, bag shaped like ornate pouch with drawstring top made of woven golden thread, exterior fabric appears as dark purple gradient with embedded golden melody note patterns, golden star decorations and music notes scattered across surface, radiating golden twinkling glow from opening, metallic clasp shaped like crescent moon with golden filigree, floating golden music notes and twinkling golden star particles surrounding bag, delicate embroidered crown of golden stars on bag face, dark purple swirl patterns with golden melody wisps, pale golden stardust particles rising from bag, bag rim decorated with tiny golden bells, soft golden twinkling illumination, professional terraria calamity mod treasure bag quality, clean pixel art 64x64 base resolution, color palette dark purple golden yellow warm golden twinkling, transparent background PNG, centered composition, item sprite game asset --v 6.1 --ar 1:1 --style raw --s 175
```

### PROMPT VARIANT: Nachtmusik Treasure Bag (Radiant)

```
terraria pixel art treasure bag boss loot container, nachtmusik golden starlit melody themed, regal drawstring pouch with dark purple interior visible at opening, exterior features dark purple fabric with woven golden thread forming melody note patterns and music staff lines, golden metal trim and clasp decorated with tiny dangling golden star charms, radiant golden twinkling light emanating from bag opening suggesting melodic treasures, floating golden quarter notes and treble clefs in golden sparkles around bag, embroidered golden star queen silhouette on bag face, dark purple melody wisps trailing from bag, ornate golden crown motif at drawstring top, golden stardust and melody particles, professional pixel art matching terraria calamity treasure bags, 64x64 pixel sprite clean edges, color scheme dark purple with rich gold and golden twinkling accents, elegant nocturnal melody presence, transparent background for game implementation --v 6.1 --ar 1:1 --style raw --s 200
```
...
*A dark and ominous treasure bag for the Dies Irae boss. Features white, black, and crimson hellfire accents, evoking Hell's Retribution and divine judgment.*

### PROMPT: Dies Irae Treasure Bag

```
pixel art treasure bag sprite terraria style, dies irae hell's retribution theme, bag shaped like ancient cursed satchel with heavy iron chains, exterior fabric appears as charred black leather with cracked white-hot fissure lines and crimson hellfire glow, skull motif clasp with crimson gem eyes, climbing white and crimson flames soaring at bag edges, floating white-hot cinders and black ash wisps surrounding bag, ominous crimson glow emanating from opening, gothic cross and judgment scale symbols embroidered in crimson, heavy black chains wrapped around bag base trailing into darkness, cracked fractures revealing white hellfire within, banishment runes etched into leather, brimstone smoke rising, professional terraria calamity mod treasure bag quality, clean pixel art 64x64 base resolution, color palette black white crimson hellfire accents, dark foreboding presence, transparent background PNG, centered composition, item sprite game asset --v 6.1 --ar 1:1 --style raw --s 175
```

### PROMPT VARIANT: Dies Irae Treasure Bag (Infernal)

```
terraria pixel art treasure bag boss loot container, dies irae hell's retribution themed, ominous bag shaped as ancient iron-bound satchel exuding divine judgment, exterior features cracked black leather with white-hot fracture veins pulsing crimson, heavy black chains and iron bands wrapped around bag, skull-shaped clasp with glowing crimson eye sockets, white and crimson hellfire visible through bag opening, floating white-hot cinders black ash particles and brimstone smoke, banishment symbols swords scales trumpets embossed in crimson, charred edges suggesting hellfire damage, gothic metal spikes and studs, ominous crimson aura radiating outward, crumbling black ash falling from bag, professional pixel art matching terraria calamity treasure bags, 64x64 pixel sprite dark and foreboding, color scheme black white crimson hellfire accents, menacing retribution presence, transparent background for game implementation --v 6.1 --ar 1:1 --style raw --s 200
```
...
*A monochromatic glass rose treasure bag for the Ode to Joy boss. Features black and white chromatic glass with prismatic refractions, evoking the eternal symphony garden.*

### PROMPT: Ode to Joy Treasure Bag

```
pixel art treasure bag sprite terraria style, ode to joy eternal symphony garden theme, bag shaped like ornate stained glass rose vessel with chromatic refractions, exterior appears as monochromatic black and white glass panels with thin leading lines forming rose petal patterns, prismatic rainbow light refracting through the white glass panels from within, black glass clasp shaped like intertwined rose thorns, floating monochromatic glass shards and prismatic sparkle particles, stained glass rose window pattern on bag face, chromatic light streamers flowing from top, delicate glass petal fragments decorating rim, eternal garden motifs and symphony symbols, prismatic radiance surrounding entire bag, black and white glass petals with rainbow refractions floating around, professional terraria calamity mod treasure bag quality, clean pixel art 64x64 base resolution, color palette monochromatic black white with prismatic chromatic refractions, ethereal radiant presence, transparent background PNG, centered composition, item sprite game asset --v 6.1 --ar 1:1 --style raw --s 175
```

### PROMPT VARIANT: Ode to Joy Treasure Bag (Divine)

```
terraria pixel art treasure bag boss loot container, ode to joy eternal symphony garden themed, bag shaped as monochromatic glass rose vessel radiating prismatic light, exterior features black and white stained glass panels with intricate rose vine leading patterns and symphony motifs, white glass panels refracting prismatic rainbow light from within, chromatic prismatic radiance streaming from bag opening suggesting crystalline treasures, floating monochromatic glass treble clefs eighth notes and prismatic sparkles, embossed glass rose window on bag face, stained glass thorn vine decorating drawstring top, ethereal chromatic light rays, glass petal shards and prismatic dust, black leading line ribbon accents, professional pixel art matching terraria calamity treasure bags, 64x64 pixel sprite monochromatic with prismatic refractions, color scheme jet black charcoal white with chromatic prismatic rainbow refractions, ethereal radiant presence, transparent background for game implementation --v 6.1 --ar 1:1 --style raw --s 200
```
...
*A shattered clock treasure bag for the Clair de Lune boss. Features dark red, vibrant gray, and white with crackling destruction energy, evoking shattered time and blazing clocks.*

### PROMPT: Clair de Lune Treasure Bag

```
pixel art treasure bag sprite terraria style, clair de lune shattered time theme, bag shaped like cracked clockwork satchel with broken gear fragments protruding, exterior fabric appears as dark gray metallic surface with deep crimson red fracture lines crackling across it, shattered white clock face clasp with broken hands, dark red destruction energy crackling from opening, floating white clock fragments gray gear shards and crimson energy sparks surrounding bag, embroidered broken clock face with scattered Roman numerals, jagged crack patterns in dark red across gray metal surface, tiny broken gear teeth decorating rim, shattered hourglass motifs with white sand frozen mid-scatter, crackling red energy tendrils trailing from bag, professional terraria calamity mod treasure bag quality, clean pixel art 64x64 base resolution, color palette dark gray vibrant gray dark crimson red white shattered glass, destructive temporal presence, transparent background PNG, centered composition, item sprite game asset --v 6.1 --ar 1:1 --style raw --s 175
```

### PROMPT VARIANT: Clair de Lune Treasure Bag (Ethereal)

```
terraria pixel art treasure bag boss loot container, clair de lune shattered time themed, destructive bag shaped as cracked clockwork vessel fracturing apart, exterior features dark gray metal panels with deep crimson red energy crackling through fracture lines, broken white clock face fragments embedded in the surface, jagged shattered glass edges with red destruction glow, dark red energy and white clock hand fragments visible through bag opening suggesting temporal devastation, floating broken gear pieces white numeral shards and crimson crackling sparks, embossed shattered clock tower on bag face, broken pendulum chain dangling from drawstring, frozen time debris and red energy tendrils, gray metal shard and white glass fragment accents, professional pixel art matching terraria calamity treasure bags, 64x64 pixel sprite dark and destructive, color scheme dark gray vibrant gray dark crimson red white with crackling red energy highlights, temporal destruction presence, transparent background for game implementation --v 6.1 --ar 1:1 --style raw --s 200
```
