...
// Unlike standard circular beams, this creates a crescent moon profile —
// thicker on one side, tapered on the other — for the Moonlight Sonata theme.
//
// UV Layout:
...
//
// Techniques:
//   CrescentBeam   — Main beam body with crescent cross-section
//   CrescentCorona — Outer corona glow pass (softer, wider)
//
// Features:
