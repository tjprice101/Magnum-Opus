...
//   - White-hot core → scarlet → gold gradient
...
float4 HeroicFlameFlowPS(float4 sampleColor : COLOR0, float2 coords : TEXCOORD0) : COLOR0
{
    ...
    // Head: white-hot → scarlet body → gold embers at tail
...
technique HeroicFlameFlow
{
    pass P0
    {
        PixelShader = compile ps_2_0 HeroicFlameFlowPS();
    }
}
...
technique HeroicFlameGlow
{
    pass P0
    {
        PixelShader = compile ps_2_0 HeroicFlameGlowPS();
    }
}
