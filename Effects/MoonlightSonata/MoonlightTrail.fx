...
//
// Techniques:
//   MoonlightFlowTrail   EMain flowing trail with sine-wave water distortion
//   MoonlightGlowPass    ESofter additive bloom overlay for glow stacking
//
// Features:
...
// 0ↁEↁE bump (peak at center, 0 at edges)
...
technique MoonlightFlowTrail
{
    pass P0
    {
        PixelShader = compile ps_3_0 MoonlightFlowPS();
    }
}
...
technique MoonlightGlowPass
{
    pass P0
    {
        PixelShader = compile ps_3_0 MoonlightGlowPS();
    }
}
